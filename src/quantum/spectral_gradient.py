...
def spectral_gradient(model, x, u, delta=1e-3, N=16, state_solver=None, **kwargs):
    """
    Return the classical gradient with respect to the control.

    The function signature is kept unchanged for compatibility with the
    rest of the codebase, even though delta, N, state_solver, and kwargs
    are not used here.
    ...
    -------
    grad : ndarray
        Classical gradient with respect to the control.
    """
